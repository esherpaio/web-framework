...
class ColorExtraction(EventListener):
    """This implementation of EventListener extracts the colors used in rendering a
    PDF."""
    ...
    def get_color_from_pdf(
        ...
        :param max_number_of_colors_to_return:      the maximum number of colors to return
        :param max_number_of_colors_to_register:    the maximum number of colors to register
