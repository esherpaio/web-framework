...
from web.pdf.pdf.canvas.layout.page_layout.multi_column_layout import (
    MultiColumnLayout,
)
...
class HeaderFooterMultiColumnLayout(MultiColumnLayout):
    """This implementation of MultiColumnLayout allows you to specify a header and
    footer.

    In order to render the header and footer you need to provide their maximum
    height(s) and a typing.Callable which will do the actual rendering.
    """
    ...
    def switch_to_next_page(self) -> "PageLayout":
        """This function forces this PageLayout to switch to the nex Page This function
        returns self.
