...
from web.pdf.pdf.canvas.canvas_graphics_state import CanvasGraphicsState
...
class ChunkOfTextRenderEvent(Event, ChunkOfText):
    """This implementation of Event is triggered right after the Canvas has processed a
...
class LeftToRightComparator:
    ...
    This comparator favors left-to-right, up-to-down text reading order. This
    corresponds to the expected western language reading order.
    """
    ...
    def cmp(obj0: ChunkOfTextRenderEvent, obj1: ChunkOfTextRenderEvent):
        """This function compares two ChunkOfTextRenderEvent objects returning a
        negative number if obj0 occurs first in the (western) reading order, and a
