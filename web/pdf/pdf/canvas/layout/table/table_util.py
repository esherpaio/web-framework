...
from web.pdf.pdf.canvas.color.color import HexColor
from web.pdf.pdf.canvas.layout.table.fixed_column_width_table import (
...
class TableUtil:
    """This class contains utility methods for using the Table classes."""
    ...
    def from_2d_array(
        ...
        :param round_to_n_digits:       this value is None if digits should not be rounded
