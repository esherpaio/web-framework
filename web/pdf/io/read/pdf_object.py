...
if TYPE_CHECKING:
    from web.pdf.io.read.types import Reference
...
class PDFObject:
    ...
    It has some convenience methods that allow you to specify how the object should be
    persisted, as well as some methods to traverse the object-graph.
    """
    ...
    def _to_json(self, memo_dict={}) -> typing.Any:
        ...
        # Boolean
        from web.pdf.io.read.types import Boolean

        if isinstance(self, Boolean):
            return bool(self)

        # CanvasOperatorName
        from web.pdf.io.read.types import CanvasOperatorName

        if isinstance(self, CanvasOperatorName):
            return str(self)

        # Decimal
        from web.pdf.io.read.types import Decimal
        ...
        # Element
        from web.pdf.io.read.types import Element

        if isinstance(self, Element):
            from web.pdf.io.read.types import ET
        ...
        # String
        from web.pdf.io.read.types import String
        ...
        # List
        from web.pdf.io.read.types import List
    ...
    @staticmethod
    def add_pdf_object_methods(object_: typing.Any) -> typing.Any:
        ...
        It also adds a utility hashing method for images (since PIL normally does not
        hash images)
        :param object_:
        :return:
        """
        ...
        object_.set_parent = MethodType(_set_parent, object_)
        object_.get_parent = MethodType(_get_parent, object_)
        object_.get_root = MethodType(_get_root, object_)
        object_.set_reference = MethodType(_set_reference, object_)
        object_.get_reference = MethodType(_get_reference, object_)
        object_.set_is_inline = MethodType(_set_is_inline, object_)
        object_.is_inline = MethodType(_is_inline, object_)
        object_.set_is_unique = MethodType(_set_is_unique, object_)
        object_.is_unique = MethodType(_is_unique, object_)
        object_.__deepcopy__ = MethodType(_deepcopy_and_add_methods, object_)
    ...
    def is_inline(self) -> bool:
        """
        This function returns True if this PDFObject should be persisted inline, False
        otherwise
    ...
    def is_unique(self) -> bool:
        """This function returns True if this PDFObject should always be treated as if
        it is unique (for IO purposes), regardless of hashing equality.
    ...
    def to_json(self) -> typing.Any:
        """
        This function converts this PDFObject into a set of nested dictionaries, lists
        and primitives
