...
class CharacterSetListener(EventListener):
    """This implementation of WriteBaseTransformer is responsible for determining which
    characters (typing.Set[str]) are used by which Font.

    This is particularly useful when performing Font subsetting.
    """
