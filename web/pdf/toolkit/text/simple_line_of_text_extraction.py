...
class SimpleLineOfTextExtraction(EventListener):
    """This implementation of EventListener extracts all lines of text from a PDF
    Document."""
    ...
    def _end_page(self, page: Page):
        ...
        for chunks_of_text_partition in chunks_of_text_disjoint_set.sets():
            ...
            assert isinstance(obj, LineOfText)
            lines_of_text.append(obj)
    ...
    def get_lines_of_text_from_pdf(
        ...
        :return:        the LineOfText objects per page
        """
        ...
        for page_nr in range(0, number_of_pages):
            ...
            obj: "SimpleLineOfTextExtraction" = SimpleLineOfTextExtraction()
            # process Page
            ...
            lines_of_text_per_page[page_nr] = obj.get_lines_of_text()[0]
        # return
