...
from web.pdf.pdf.page.page_info import PageInfo
...
class Page(Dictionary):
    ...
    def _initialize_page_content_stream(self) -> "Page":
    ...
    def append_to_content_stream(self, s: str) -> "Page":
        """
    ...
    def apply_redact_annotations(self):
        ...
        from web.pdf.pdf.canvas.redacted_canvas_stream_processor import (
    ...
    def has_form_field(self, field_name: str) -> bool:
        """
        This function returns True if this Page contains a form field with the name
        :param field_name:  the field_name to be queried
        :return:            True if this Page contains a form field with the name
        """
