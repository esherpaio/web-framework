...
from doc.io.read.types import AnyPDFType, Dictionary, List, Reference, Stream
...
class ArrayTransformer(Transformer):
    """This implementation of WriteBaseTransformer is responsible for writing List
    objects."""
    ...
    def can_be_transformed(self, any_: AnyPDFType):
        """This function returns True if the object to be converted represents a List
        object."""

        return isinstance(any_, List)
