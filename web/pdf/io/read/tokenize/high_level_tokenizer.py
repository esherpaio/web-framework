...
from web.pdf.io.read.tokenize.low_level_tokenizer import (
    LowLevelTokenizer,
    TokenType,
)
...
class HighLevelTokenizer(LowLevelTokenizer):
    ...
    def read_dictionary(self) -> Dictionary:
        ...
        It fails and throws various errors if the next tokens do not represent a
        Dictionary.
        """
        token = self.next_non_comment_token()
        assert token is not None
    ...
    def read_indirect_object(self) -> Optional[AnyPDFType]:
        ...
        It fails and throws various errors if the next tokens do not represent an
        indirect pdf object.
        """
    ...
    def read_object(self, xref: Optional["XREF"] = None) -> Optional[AnyPDFType]:
        ...
        It fails and throws various errors if the next tokens do not represent a pdf
        object.
        """
    ...
    def read_stream(self, xref: Optional["XREF"] = None) -> Optional[Stream]:
        ...
        bytes_ = self._io_source.read(int(length_of_stream))
        ...
        # set Bytes
        stream_dictionary[Name("Bytes")] = bytes_
