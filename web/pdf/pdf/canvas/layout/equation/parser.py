...
from web.pdf.pdf.canvas.layout.equation.tokenizer import Tokenizer
...
class Parser:
    ...
    other hierarchical structure, giving a structural representation of the input while
    checking for correct syntax.

    The parsing may be preceded or followed by other steps, or these may be combined
    into a single step.
    """
