...
class BitArray:
    """This class works allows you to work with a bytes input and retrieve individual
    bits (as integers)"""
...
class LZWDecode:
    """Decompresses data encoded using the LZW (Lempel-Ziv- Welch) adaptive compression
    ...
    def decode(self, input_: bytes):
        ...
        # read
        bit_input: BitArray = BitArray(input_)
        prev_code: int = 0
        code: int = 0
