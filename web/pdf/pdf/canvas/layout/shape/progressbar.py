...
class ProgressBar(LayoutElement):
    ...
    It displays a rectangular shape of fill_color, overlaid with a (smaller)
    rectangular shape of stroke_color. This implementation of ProgressBar is roughly
    size 12 font wide.
    """
