...
class FarrowAndBall(HexColor):
    """Farrow & Ball is a British manufacturer of paints and wallpapers largely based
    upon historic colour palettes and archives.
    ...
    def find_nearest_farrow_and_ball_color(color: Color) -> "FarrowAndBall":
        """This function find the nearest `Farrow and Ball` equivalent for a given
        Color."""
