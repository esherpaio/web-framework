...
class FlateDecode:
    ...
    def decode(
        ...
        # sampled images is to replace each sample with the difference between that
        # sample and a predictor function applied to earlier neighboring samples. If the
        # predictor function works well, the postprediction data clusters toward 0.
        # PDF supports two groups of Predictor functions. The first, the TIFF group,
        # consists of the single function that is Predictor 2 in the TIFF 6.0
        # specification.
