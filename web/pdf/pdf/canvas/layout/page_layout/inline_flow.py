...
class InlineFlow(LayoutElement):
    """This implementation of LayoutElement aggregates other LayoutElements and lays
    them out on consecutive lines.

    If a line is full, it overflows into the next line.
    """
