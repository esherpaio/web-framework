...
class ReadTransformerState:
    """This class represents all the meta-information used in the process of reading a
    PDF document.
...
class Transformer:
    ...
    Add children to handle specific cases (transforming dictionaries, arrays, xref,
    etc)
    """
    ...
    @staticmethod
    def _is_recursive_object(object_to_transform) -> bool:
        try:
    ...
    def add_child_transformer(self, child_transformer: "Transformer") -> "Transformer":
        """Add a child ReadBaseTransformer to this ReadBaseTransformer.

        Child transformers can be used to encapsulate specific
        object-creation/transformation logic. e.g. creating XREF, converting arrays,
        dictionaries, etc.
        :param child_transformer: the ReadBaseTransformer implementation to be added
        :type child_transformer:  Transformer
        """
    ...
    def can_be_transformed(
        ...
        transformed by this ReadBaseTransformer."""

        return False

    def get_children(self) -> typing.List["Transformer"]:
        """This functions returns all child ReadBaseTransformers of this
        ReadBaseTransformer."""
    ...
    def get_root_transformer(self) -> "Transformer":
        ...
        This is useful when delegating calls from inside a ReadBaseTransformer to
        another. e.g. Transforming a dictionary by reading its delimiters and then
        transforming each key/value in turn by calling top-level ReadBaseTransformer
        """
