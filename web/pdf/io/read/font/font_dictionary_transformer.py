...
from web.pdf.io.read.types import AnyPDFType, Dictionary, Stream
...
from web.pdf.pdf.canvas.font.simple_font.font_type_1 import (
    StandardType1Font,
    Type1Font,
)
from web.pdf.pdf.canvas.font.simple_font.font_type_3 import Type3Font
from web.pdf.pdf.canvas.font.simple_font.true_type_font import TrueTypeFont


class FontDictionaryTransformer(Transformer):
    """This implementation of ReadBaseTransformer is responsible for reading a Font
    object."""
    ...
    def can_be_transformed(
        ...
        """This function returns True if the object to be transformed is a /Font
        Dictionary."""

        return (
            isinstance(object_, dict)
            and not isinstance(object_, Stream)
            and "Type" in object_
            and object_["Type"] == "Font"
        )
    ...
    def transform(
        ...
        if subtype_name == "TrueType":
            ...
            # But in the interest of pleasing the user, we explicitly catch these
            # errors and guide those wayward lambs back into the fold.
            if (
