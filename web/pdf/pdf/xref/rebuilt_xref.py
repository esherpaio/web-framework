...
from web.pdf.io.read.types import Name, Reference
...
class RebuiltXREF(PlainTextXREF):
    ...
    This implementation of PlainTextXREF is invoked whenever the XREF could not be
    loaded properly. This implementation will then loop over the entire PDF file to
    find obj declaration statements.
    """
