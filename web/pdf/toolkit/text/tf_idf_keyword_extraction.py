...
class TFIDFKeywordExtraction(SimpleTextExtraction):
    ...
    often used as a weighting factor in searches of information retrieval, text mining,
    and user modeling.
    ...
    the word, which helps to adjust for the fact that some words appear more frequently
    in general.

    tf–idf is one of the most popular term-weighting schemes today. A survey conducted
    in 2015 showed that 83% of text- based recommender systems in digital libraries use
    tf–idf.
    ...
    One of the simplest ranking functions is computed by summing the tf–idf for each
    ...
    def get_keywords(self) -> typing.Dict[int, typing.List[typing.Tuple[str, float]]]:
        """This function returns a typing.List[typing.Tuple[str, float]] for a given
        page."""
    ...
    def get_keywords_from_pdf(
        ...
        for page_nr in range(0, number_of_pages):
            ...
            obj: "TFIDFKeywordExtraction" = TFIDFKeywordExtraction()
            # process Page
