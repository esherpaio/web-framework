...
from web.pdf.io.read.types import List, Name
...
from web.pdf.pdf.canvas.layout.annotation.polyline_annotation import (
    LineEndStyleType,
)


class LineAnnotation(Annotation):
    """The purpose of a line annotation (PDF 1.3) is to display a single straight line
    on the page.

    When opened, it shall display a pop-up window containing the text of the associated
    note. Table 175 shows the annotation dictionary entries specific to this type of
    annotation.
    """
