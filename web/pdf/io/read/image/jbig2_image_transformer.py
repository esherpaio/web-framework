...
from web.pdf.io.read.types import AnyPDFType, Stream
...
class JBIG2ImageTransformer(Transformer):
    """This implementation of ReadBaseTransformer is responsible for reading a jbig2
    image object."""
    ...
    def can_be_transformed(
        ...
        """This function returns True if the object to be transformed is a JBIG2
        object."""
        ...
        return (
            ...
            and (
                object_["Filter"] == "JBIG2Decode"
                or (
                    isinstance(object_["Filter"], list)
                    and object_["Filter"][0] == "JBIG2Decode"
                )
            )
        )
