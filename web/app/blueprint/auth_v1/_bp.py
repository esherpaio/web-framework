...
auth_v1_js_login = JsBundle(os.path.join(_dir, "static", "login.js"))
auth_v1_js_password = JsBundle(os.path.join(_dir, "static", "password.js"))
auth_v1_js_register = JsBundle(os.path.join(_dir, "static", "register.js"))
