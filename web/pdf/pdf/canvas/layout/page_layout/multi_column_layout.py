...
from web.pdf.pdf.canvas.layout.page_layout.page_layout import PageLayout
...
class MultiColumnLayout(PageLayout):
    ...
    and lays out the content on the Page as if there were multiple columns to flow
    text, images, etc into.

    Once a column is full, the next column is automatically selected, although the next
    column can be manually selected.
    """
    ...
    def __init__(
        ...
        self._page_width: typing.Optional[Decimal] = (
        ...
        self._previous_element_layout_rect: typing.Optional[Rectangle] = None
    ...
    def add(self, layout_element: LayoutElement) -> "PageLayout":
        ...
        if self._previous_element is not None:
            prev_element_prev_layout_box: typing.Optional[Rectangle] = (
        ...
        available_space: Rectangle = Rectangle(
            ...
            * (self._column_width + self._inter_column_margin)
    ...
    def switch_to_next_column(self) -> "PageLayout":
        """This function forces this PageLayout to move to the next column on the
        Page."""
...
class SingleColumnLayout(MultiColumnLayout):
    """This implementation of PageLayout adds left/right/top/bottom margins to a Page
    and lays out the content on the Page as if there were was a single column to flow
    text, images, etc into.
