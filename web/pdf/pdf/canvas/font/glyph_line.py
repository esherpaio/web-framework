...
class Glyph:
    """In typography, a glyph /ɡlɪf/ is an elemental symbol within an agreed set of
    symbols, intended to represent a readable character for the purposes of writing.

    Glyphs are considered to be unique marks that collectively add up to the spelling
    of a word or contribute to a specific meaning of what is written, with that meaning
    dependent on cultural and social usage.
    """
...
class GlyphLine:
    ...
    def add(self, glyph_or_glyphline: typing.Union[Glyph, "GlyphLine"]) -> "GlyphLine":
        """This function appends a Glyph (or all Glyph objects in a GlyphLine) to this
        GlyphLine.
    ...
    def from_str(
        ...
        glyphs: typing.List[Glyph] = [
            Glyph(cid, text[i], font.get_width(cid) or Decimal(0))
    ...
    def get_text(self) -> str:
        """This function returns the unicode str represented by the Glyph objects in
        this GlyphLine."""
    ...
    def split(self) -> typing.List["GlyphLine"]:
        """This function splits the GlyphLine into several GlyphLine objects, one per
        Glyph in the (original, this) GlyphLine."""
    ...
    def uses_descent(self) -> bool:
        """This function returns True if any of the Glyph objects in the GlyphLine has
        a non-zero descent, False otherwise."""
