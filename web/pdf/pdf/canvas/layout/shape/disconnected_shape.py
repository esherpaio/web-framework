...
from web.pdf.pdf.canvas.color.color import Color, HexColor, X11Color
...
class DisconnectedShape(LayoutElement):
    ...
    def move_to(
        ...
        """This method translates this DisjointShape so its lower left corner aligns
    ...
    def rotate(self, angle_in_radians: float) -> "DisconnectedShape":
        ...
        self._lines = [
            (
                (a * line[0][0] + c * line[0][1], b * line[0][0] + d * line[0][1]),
                (a * line[1][0] + c * line[1][1], b * line[1][0] + d * line[1][1]),
            )
            for line in self._lines
        ]
        return self
    ...
    def scale_down(
        ...
        """This method scales this Shape down to fit a given max.
