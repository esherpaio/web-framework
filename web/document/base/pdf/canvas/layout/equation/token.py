...
class TokenType(enum.Enum):
    """This enum represents the various kinds of Token objects the Equation parser can
    encounter."""
...
class Token:
    """This module contains everything needed to represent a low-level token in
    mathematical syntax."""
    ...
    def __init__(
        ...
        text: str = "",
        type_: TokenType = TokenType.NUMBER,
    ):
