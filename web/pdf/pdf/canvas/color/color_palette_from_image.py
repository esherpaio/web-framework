...
from web.pdf.pdf import HexColor, RGBColor
from web.pdf.pdf import Image as bImage


class ColorPaletteFromImage:
    """This class provides functions to extract a color palette (typing.List[Color])
    from an Image (specified by str, Path, PIL Image)"""
    ...
    def color_palette_from_image(
        ...
        :param img:     the input Image (specified by str, Path, or PIL Image)
