...
from web.pdf.io.read.types import AnyPDFType, Decimal, Dictionary, Name
...
class RootDictionaryTransformer(Transformer):
    """This implementation of ReadBaseTransformer is responsible for reading the
    /Catalog object."""
    ...
    @staticmethod
    def _re_order_pages(root_dictionary: dict) -> None:
