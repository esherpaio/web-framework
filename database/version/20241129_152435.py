...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["route_id"], ["app_route.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=64), nullable=False),
        sa.Column(
            "state_required", sa.Boolean(), server_default="false", nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=64), nullable=False),
        sa.Column(
            "consent_required", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column("slug", sa.String(length=64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=64), nullable=False),
        sa.Column(
            "phone_required", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "unit_price",
            sa.Numeric(precision=10, scale=4, asdecimal=False),
    ...
    op.create_table(
        ...
        sa.Column("bulk_email", sa.Boolean(), server_default="true", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("vat_reverse", sa.Boolean(), server_default="false", nullable=False),
        sa.Column("billing_id", sa.Integer(), nullable=True),
