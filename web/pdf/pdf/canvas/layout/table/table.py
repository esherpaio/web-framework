...
class TableCell(LayoutElement):
    ...
    def __init__(
        ...
        padding_left: Decimal = Decimal(4),
        padding_right: Decimal = Decimal(4),
        padding_top: Decimal = Decimal(4),
...
class Table(LayoutElement):
    """This class represents a common base for all LayoutElement implementations that
    attempt to represent tabular data."""
    ...
    def even_odd_row_colors(
        ...
        """This function colors the Table with the classic "zebra stripes" e.a.

        one color for all even rows, and a contrasting color for the odd rows.
        :param even_row_color:      the Color to be used for even rows
        :param odd_row_color:       the Color to be used for odd rows
        :param header_row_color:    the Color to be used for the header row
        This function returns self.
        """
    ...
    def internal_borders(self) -> "Table":
        """This method sets the border(s) on all TableCell objects in this Table except
        for the borders that form the outside edge of the Table."""
    ...
    def set_background_color_on_all_cells(self, background_color: Color) -> "Table":
        """This method sets the background Color on all TableCell objects in this
        Table."""
